<!-- Archived 2026-07-30. Superseded by /README.md once the pipeline, dashboard,
     and deploy were actually finished — this was the placeholder written at
     Prompt 1 (initial scaffolding), before any of it existed. Kept for the
